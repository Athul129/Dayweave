...
function WeeklyView({ tasks, selectedDay, setSelectedDay, openCreate, openEdit, setActiveId, toggleTask, showToast, weekDays, weekLabel, weekOffset, onPreviousWeek, onNextWeek, onToday }: { tasks: Task[]; selectedDay: string; setSelectedDay: (date: string) => void; openCreate: (title?: string, date?: string) => void; openEdit: (task: Task) => void; setActiveId: (id: string | null) => void; toggleTask: (id: string) => void; showToast: (message: string) => void; weekDays: WeekDay[]; weekLabel: string; weekOffset: number; onPreviousWeek: () => void; onNextWeek: () => void; onToday: () => void }) {
